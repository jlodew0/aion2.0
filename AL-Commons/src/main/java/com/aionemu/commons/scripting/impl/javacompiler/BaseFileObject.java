 ...
 */
public abstract class BaseFileObject implements javax.tools.JavaFileObject {
    protected BaseFileObject(JavaFileManager fileManager) {
    ...
    protected static JavaFileObject.Kind getKind(String filename) {
        return BaseFileObject.getKind(filename);
    }
